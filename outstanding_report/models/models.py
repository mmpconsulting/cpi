...
class OutstandingReport(models.Model):
    ...
    def action_submit(self):
        _logger.info(f'Action submit called for report ID: {self.id}, Company ID: {self.company_id.id}, Company Name: {self.company_id.name}')
...
class OutstandingReportSo(models.Model):
    ...
    def action_submit(self):
        _logger.info(f'Action submit called for report ID: {self.id}, Company ID: {self.company_id.id}, Company Name: {self.company_id.name}')
        return self.env.ref('outstanding_report.outstanding_purchase_order_report_action_so').report_action(self)
